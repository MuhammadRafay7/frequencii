 ...
 * @param {string} [props.badge='Become A Frontend Developer'] - Badge text to display
 * @param {string} [props.title='Want to learn how to build templates like this one?'] - Main heading text
 * @param {string} [props.buttonText='Visit www.pixelrocket.store'] - Button text
 * @param {string} [props.buttonUrl='https://www.pixelrocket.store'] - Button URL
 * @param {boolean} [props.showArrow=true] - Whether to show arrow icon in button
 * @param {string} [props.className=''] - Additional CSS classes
 * @param {string} [props.backgroundImagePath='/images'] - Path to background images
 */
const CTASection = ({
